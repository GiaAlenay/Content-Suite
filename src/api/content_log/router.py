...
#     "/list",
#     dependencies=[
#         Depends(require_permissions(["backAdmin:content_log.read", "intranet:content_log.read"]))
#     ],
# )
# def get_all():
...
# @router.post(
#     "/create", dependencies=[Depends(require_permissions(["backAdmin:content_log.create"]))]
# )
...
#     dependencies=[Depends(require_permissions(["backAdmin:content_log.read"]))],
# )
# def get_by_id(id_content_log: int):
#     result_content_log = ContentLogUseCase().get_by_id(id_content_log)
#     return result_content_log


# @router.get(
#     "/get_by_content_log_name/{content_log_name}",
#     dependencies=[Depends(require_permissions(["backAdmin:content_log.read"]))],
# )
